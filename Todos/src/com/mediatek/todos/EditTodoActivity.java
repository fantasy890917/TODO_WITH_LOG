...
public class EditTodoActivity extends Activity implements TimeChangeListener, QueryListener,View.OnLongClickListener {
    ...
    private void initViews() {
		LogUtils.d(TAG, "shiguibiao-initViews()");
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		LogUtils.d(TAG, "shiguibiao-onRestoreInstanceState()");
    ...
    LogUtils.d(TAG, "shiguibiao-changeToState()");
        mState = state;
    ...
    LogUtils.d(TAG, "shiguibiao-getExpireCode()");
        if (info != null) {
    ...
    private class EditTodoListeners implements View.OnClickListener, OnDateSetListener {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
			LogUtils.d(TAG, "shiguibiao-onDateSet(), year ="+year+" month ="+monthOfYear+" day="+dayOfMonth);
    ...
    public void onClickSetDueDate() {
		LogUtils.d(TAG, "shiguibiao-onClickSetDueDate()");
        hideIMEFromWindow();
    ...
    LogUtils.d(TAG, "shiguibiao-showDatePicker()");
        Time time = new Time();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	 LogUtils.d(TAG, "shiguibiao-onCreateOptionsMenu()");
    ...
    LogUtils.d(TAG, "shiguibiao-onPrepareOptionsMenu()");
        switch (mState) {
        case STATE_ADD_NEW:
        case STATE_EDIT_TODO:
    ...
    private void configureActionBar() {
		LogUtils.d(TAG, "shiguibiao-configureActionBar()");
